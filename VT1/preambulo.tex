...
\definecolor{color2}{rgb}{0.7843137254901961,0.7843137254901961,0.7843137254901961}
...
\fancypagestyle{estandar}{%
	...
	\fancyfoot[RO]{\settowidth{\nombrecapitulo}{\chaptitle}\setlength{\arrayrulewidth}{0.7pt}\setlength{\tabcolsep}{3pt}\arrayrulecolor{white!60!black}
		...
		\fancyfoot[LE]{\settowidth{\nombrecapitulo}{Estadísticas Vitales I-2014}\setlength{\arrayrulewidth}{0.7pt}\setlength{\tabcolsep}{3pt}\arrayrulecolor{white!60!black}
			\margenizquierdo{
				\begin{tabular}{x{0.2cm}}
					$\ $\\[41.2\cuadri]
					\piecapituloizquierdo{\rotatebox{90}{\color{white!60!black}Estadísticas Vitales I-2014$\vphantom{q}$}} \\[-1\cuadri] \hline \\[-0.6\cuadri]
